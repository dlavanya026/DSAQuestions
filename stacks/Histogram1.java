...
public class Histogram1 {
    public static int getMaxAreaNaive(int arr[],int n){
        int res=0;
        for(int i=0;i<n;i++){
            int curr=arr[i];
            for(int j=i-1;j>=0;j--){
    ...
    public static void main (String[] args) {
        ...
        System.out.print("Maximum Area: "+getMaxAreaEfficient(arr,arr.length));

        System.out.print("Maximum Area: "+getMaxAreaNaive(arr,arr.length));
